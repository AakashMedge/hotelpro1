    ...
    return (
        <div className="h-full bg-white flex flex-col overflow-hidden">
            <div className="px-6 py-6 border-b border-zinc-100 shrink-0">
                <h1 className="text-xl font-bold text-[#111111] tracking-tight">Ledger</h1>
                <p className="text-[10px] text-zinc-400 font-medium uppercase tracking-widest mt-1">Transaction History</p>
            </div>
            ...
            <div className="grow flex flex-col items-center justify-center opacity-20 text-center gap-4 px-6">
                ...
                <p className="text-[10px] text-zinc-400 font-semibold uppercase tracking-widest leading-relaxed">No transactions recorded <br /> for this terminal today</p>
            </div>
        </div>
    );
}
